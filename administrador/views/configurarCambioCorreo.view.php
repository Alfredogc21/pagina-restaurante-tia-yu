...
<head>
  ...
  <link rel="stylesheet" href="views/estilos/configurarCambioCorreo.css">
        ...
        <div class="welcome-card">
            <main>
                <form method="post" id="signup" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="form-singup">
                    ...
                    <input class="controls" type="email" name="correo" id="correo" placeholder="Escribe el correo" required>
                    <br></br>
